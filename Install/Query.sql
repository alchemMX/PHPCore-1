...
DROP TABLE IF EXISTS `phpcore_verify_waiting`;
...
CREATE TABLE IF NOT EXISTS `phpcore_buttons` (
  ...
  `button_name` varchar(225) COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `phpcore_buttons_sub` (
  ...
  `page_id` bigint(11) DEFAULT NULL,
  `button_sub_name` varchar(225) COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `phpcore_categories` (
  ...
  `category_description` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `position_index` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `phpcore_deleted_content` (
  ...
  `user_id` bigint(11) NOT NULL,
  `deleted_type` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpcore_forums` (
  ...
  `category_id` bigint(11) NOT NULL,
  `forum_name` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpcore_groups` (
  ...
  `group_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `group_class_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `group_color` varchar(225) COLLATE utf8_general_ci NOT NULL,
...
('Uživatel', 'uzivatel', '#555555', 'post.create,topic.create,profilepost.create', 1),
('Administrátor', 'administrator', '#3174d7', '*', 2);
...
CREATE TABLE IF NOT EXISTS `phpcore_labels` (
  ...
  `label_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `label_class_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `label_color` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `position_index` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `phpcore_logs` (
  ...
  `user_id` bigint(11) NOT NULL,
  `log_action` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `log_text` varchar(225) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpcore_notifications` (
  ...
  `notification_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `notification_text` varchar(225) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpcore_pages` (
  ...
  `page_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `page_url` varchar(225) COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`page_id`)
) DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `phpcore_posts` (
  ...
  `post_text` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpcore_reports` (
  ...
  `report_type` varchar(225) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpcore_topics` (
  ...
  `deleted_id` bigint(11) DEFAULT NULL,
  `report_id` bigint(11) DEFAULT NULL,
  `topic_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `topic_text` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `topic_url` varchar(225) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `phpcore_users` (
  ...
  `group_id` bigint(11) NOT NULL,
  `user_name` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `user_hash` varchar(225) COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `user_password` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `user_registered` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `user_email` varchar(225) COLLATE utf8_general_ci NOT NULL,
  `user_text` varchar(225) COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `phpcore_users_notifications` (
  ...
  `user_id` bigint(11) NOT NULL,
  `user_notification_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_notification_type_id` int(11) NOT NULL,
  `user_notification_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
