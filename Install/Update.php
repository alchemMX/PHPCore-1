...
$this->db->query('ALTER TABLE ' . explode(' ', TABLE_REPORTS_REASONS)[0] . ' CHANGE COLUMN IF EXISTS `reason_id` report_reason_id bigint(11) NOT NULL AUTO_INCREMENT');
...
$this->db->query('ALTER TABLE ' . explode(' ', TABLE_REPORTS_REASONS)[0] . ' CHANGE COLUMN IF EXISTS `report_reason_time` report_reason_created  DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP');