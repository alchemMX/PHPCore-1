...
$language['L_NOTICE'] = [
    ...
    'L_FAILURE' => [
        ...
        'notification_name' => 'Zadejte název upozornění',
    ...
    'L_SUCCESS' => [
        ...
        'Admin/Deleted/Topic/Back' => 'Téma bylo úspěšně vaceno zpět do fóra',
        'Admin/Deleted/Topic/Delete' => 'Téma bylo úspěšně smazáno',

        'Admin/Deleted/ProfilePost/Back' => 'Profilový příspěvek byl úspěšně vacen zpět na profil',
        'Admin/Deleted/ProfilePost/Delete' => 'Profilový příspěvek byl úspěšně smazán',

        'Admin/Deleted/ProfilePostComment/Back' => 'Profilový komentář byl úspěšně vacen zpět pod profilový příspěvek',
        ...
        'Admin/Settings/Index' => 'Nastavení webových stránek bylo úspěšně změneno',
        'Admin/Settings/Other' => 'Nastavení webových stránek bylo úspěšně změneno',
        'Admin/Settings/Registration' => 'Nastavení webových stránek bylo úspěšně změneno',
        'Admin/Settings/Email' => 'Nastavení bylo úspěšně změneno',
        ...
        'Admin/Template/Set' => 'Výchozí šablona byla úspěšně změněna',
        ...
        'Admin/Notification/Create' => 'Upozornění bylo úspěšně vytvořeno',
        'Admin/Notification/Delete' => 'Upozornění bylo úspěšně smazána',
        ...
        'Admin/Menu/Dropdown/Delete' => 'Rozbalovací seznam byl úspěšně smazán',
