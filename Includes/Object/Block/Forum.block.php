...
class Forum extends Block
{
    ...
    /**
     * Returns forums from given category
     *
    ...
    /**
     * Returns all forums to which topics can be moved
     * 
     * @param int $forumID Forum ID which will be ignored
     *
     * @return array
     */
    ...
    /**
     * Returns id of all group which has permission to see forum
     *
     * @param  int $forumID Forum ID
     * 
     * @return array
    ...
    /**
     * Returns id of all group which has permission to create post in forum
     *
     * @param  int $forumID Forum ID
     * 
     * @return array
    ...
    /**
     * Returns id of all group which has permission to create topic in forum
     *
     * @param  int $forumID Forum ID
     * 
     * @return array
