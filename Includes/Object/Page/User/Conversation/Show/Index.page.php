...
class Index extends \Page\Page
{
    ...
    protected function body()
    {
        ...
        $this->data->data['lastMessage'] = $conversationMessage->getLast($this->getID());
        if (!$this->data->data['lastMessage']) {
            $this->data->data['lastMessage'] = $conversation;
        }
        ...
        if ($conversation['user_id'] == LOGGED_USER_ID) $panel->object('edit')->show();
