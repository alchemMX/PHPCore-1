...
class Router extends Page
{
    ...
    public function body()
    {
        ...
        define('TEMPLATE_PATH_DEFAULT', '/Styles/' . $this->system->settings->get('site.template'));
        ...
        define('TEMPLATE_PATH', '/Styles/' . $this->system->settings->get('site.template'));
